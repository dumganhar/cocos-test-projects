import { _decorator, Component, Node, tween, tweenProgress, v3, color, CameraComponent, Canvas, geometry, Vec3, Label, Tween, EventTouch } from 'cc';
...
@ccclass('TweenBezier')
export class TweenBezier extends Component {
    ...
    start() {
        ...
        this._spline = geometry.Spline.create(geometry.SplineMode.BEZIER, renderKnots);
